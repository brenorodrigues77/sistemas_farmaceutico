...
layout = dbc.Col([
    ...
    dbc.Row([
        dbc.Col([
            dbc.CardGroup([
                ...
                dbc.Card(
                    html.Div(className="bi bi-cash-coin", style={
                             'color': 'white', 'textalign': 'center', 'fontsize': '30', 'margin': 'auto'}),
                    color='blue',
        ...
        dbc.Col([
            dbc.CardGroup([
                ...
                dbc.Card(
                    html.Div(className="bi bi-capsule", style={
                             'color': 'white', 'textalign': 'center', 'fontsize': '30', 'margin': 'auto'}),
                    color='warning',
                    style={'maxWidth': 75, 'height': 100,
                           'margin-left': '-10px'}
        ...
        dbc.Col([
            dbc.CardGroup([
                ...
                dbc.Card(
                    html.Div(className='bi bi-file-earmark-medical-fill', style={
                             'color': 'white', 'textalign': 'center', 'fontsize': '30', 'margin': 'auto'}),
                    color='green',
                    style={'maxWidth': 75, 'height': 100,
                           'margin-left': '-10px'},
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                ...
                html.Legend('Periodo de Analise por Data',
    ...
    dbc.Row([
        dbc.Col(dbc.Card(dcc.Graph(id='grafico2'),
                style={'padding': '10px'}), width=6),
        dbc.Col(dbc.Card(dcc.Graph(id='grafico3'),
                style={'padding': '10px'}), width=3),
        dbc.Col(dbc.Card(dcc.Graph(id='grafico4'),
                style={'padding': '10px'}), width=3),
    ],)
])
